...
const PasSlider = () => {
  ...
  return (
    <section className="mb-[60px] md:mb-32 px-[20px]">
      <Slider {...settings} className=" rounded-lg w-full">
        {SliderData.map((func) => {
          return (
            <div className="relative  md:mx -[40px] slider_bg_image bg-cover bg-no-repeat rounded-lg shadow-sm  object-cover pt-4 px-[12px] lg:pl-[70px] lg:pr-[125px] group">
