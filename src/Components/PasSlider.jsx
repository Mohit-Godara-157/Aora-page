...
const PasSlider = () => {
    ...
    return (
        <section className='mt-[93px] mb-32 px-[20px]'>
                        ...
                        <div className='relative  md:mx -[40px] slider_bg_image bg-cover bg-no-repeat rounded-lg shadow-lg object-cover pt-4 px-[12px] lg:pl-[70px] lg:pr-[125px] group'>
                            <div className='grid grid-cols-2 pt-[13px]'>
                                <div className='md:pt-24'>
                                    ...
                                    <p className='ff_Bariol text-[#686868] font-normal text-[14px] md:text-[20px] mt-[6px] md:mt-5'>{func.para}</p>
                                    <button className='mt-5 md:mt-10 bg-[#FFB219] py-[10px] px-4 rounded ff_Bariol font-bold text-base'>{func.button}</button>
                                </div>
                                <div className='flex justify-end'>
                                    <img className='max-w-[161px] max-h-[199px]  md:max-w-[320px] w-full md:max-h-[397px] h-full' src={func.image} alt="image" />
                                </div>
                            </div>
