...
function HeroSection() {
  return (
    <section className="  md:pb-8 pt-5 max-sm:pt-[15px] bg-[#FFB219] relative px-4 z-30 max-sm:h-[176px]">
      {" "}
      <img
      ...
      <div className="container xl:max-w-[1140px] 2xl:max-w-[1320px] mx-auto">
        <h2 className="ff_Bariol font-bold text-[#2A2A2A] text-[32px] max-sm:text-[16px]  max-sm:leading-[21px] text-center leading-8">
          Hello july
        </h2>
        <h1 className="ff_Bariol font-bold text-[#2A2A2A] text-[48px] max-md:text-[40px] max-sm:text-[20px]  max-sm:leading-[25px] text-center leading-[63px]  max-sm:mt-1">
          What services are you looking for?
        </h1>
        <div className="shadow_input max-w-[1034px] mx-auto bg-white flex items-center h-[70px] max-md:h-[50px] max-sm:h-[40px]  m px-6 rounded-lg mt-5 max-sm:mt-4 ">
